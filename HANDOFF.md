...
当前 MVP-first Goal 已推进到 75%（PR0-PR5 已验证）。最近一次修改把方向画布和交互语义收清楚了：
...
当前剩余重点不是继续堆 UI 小修，而是进入 PR6：确认新结构下的用户项目保存/恢复、备选库、以后再看和 Markdown 导出都能稳定工作。

## 建议下一步重构

优先做 PR6“持久化、导出和测试补强”，不建议跳去新功能。
